 ...
 * @author Suttida Sat
 */
@WebServlet(name = "viewBookCost", urlPatterns = {"/viewBookCost"})
public class viewBookCost extends HttpServlet {
...
public void init(){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            book.setPayment_id(i_id);
             int pID = book.getPayment_id();
             
             book.setPrice(pID);
              float price_book = book.getPrice();
